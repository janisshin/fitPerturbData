model *putida_core()
  ...
  // Reactions:  
  ext M_ccmuac_c; R_muconate_sink: $M_ccmuac_c => ;
  ext M_co2_e; R_EX_co2_e: $M_co2_e -> ; 
  ext M_glc__D_e; R_EX_glc_e: $M_glc__D_e -> ; 
  ext M_h2o_e; R_EX_h2o_e: $ M_h2o_e -> ;  
  ext M_h_e; R_EX_h_e: $M_h_e -> ; 
  ext M_nh4_e; R_EX_nh4_e: $M_nh4_e -> ; 
  ext M_o2_e; R_EX_o2_e: $M_o2_e -> ; 
  ext M_pi_e; R_EX_pi_e: $M_pi_e -> ; 
  ext M_pyr_e; R_EX_pyr_e: $M_pyr_e => ; 
  ext M_succ_e; R_EX_succ_e: $M_succ_e => ; 
  R_NH4t: M_nh4_e -> M_nh4_c;
  R_CO2t: M_co2_e -> M_co2_c;
  R_O2t: M_o2_e -> M_o2_c;  
  R_H2Ot: M_h2o_e -> M_h2o_c;
  R_PIt2r: M_h_e + M_pi_e => M_h_c + M_pi_c; 
  R_PYRt2: M_h_e + M_pyr_e -> M_h_c + M_pyr_c;
  R_SUCCt2_2: 2 M_h_e + M_succ_e => 2 M_h_c + M_succ_c;
  R_SUCCt3: M_h_e + M_succ_c => M_h_c + M_succ_e; 
  R_THD2: M_h_e + M_nadh_c + M_nadp_c => M_h_c + M_nad_c + M_nadph_c; 
  R_ATPM: M_atp_c + M_h2o_c => M_adp_c + M_h_c + M_pi_c; 
  R_ATPS4r: M_atp_c + M_h2o_c + 3 M_h_c -> M_adp_c + 4 M_h_e + M_pi_c;
  R_HCO3E: M_h_c + M_hco3_c -> M_co2_c + M_h2o_c; 
  R_NADTRHD: M_nad_c + M_nadph_c -> M_nadh_c + M_nadp_c; 

  R_ACONTa: M_cit_c -> M_acon_c + M_h2o_c;  
  R_ACONTb: M_acon_c + M_h2o_c -> M_icit_c;
  R_CATDOX: M_catechol_c + M_o2_c => M_ccmuac_c + 2 M_h_c; 
  R_CS: M_accoa_c + M_h2o_c + M_oaa_c => M_cit_c + M_coa_c + M_h_c; 
  R_CYTBD: 2 M_h_c + 1.5 M_o2_c + M_q8h2_c => M_h2o_c + 2 M_h_e + M_q8_c; 
  R_DHQTi: M_3dhq_c -> M_3dhsk_c + M_h2o_c; 
  R_ENO: M_3pg_c -> M_h2o_c + M_pep_c; 
  R_FBA: M_fdp_c -> M_dhap_c + M_g3p_c; 
  R_FBP: M_fdp_c + M_h2o_c => M_f6p_c + M_pi_c; 
  R_G6PDH2r: M_g6p_c + M_h2o_c + M_nadp_c => M_6pgc_c + 2 M_h_c + M_nadph_c; 
  R_GADktpp: M_glcn_c + M_nad_c => M_2dhglcn_c + M_h_c + M_nadh_c;
  R_GAPD: M_adp_c + M_g3p_c + M_nad_c + M_pi_c -> M_3pg_c + M_atp_c + M_h_c + M_nadh_c; 
  R_GLCDpp: M_glc__D_c + M_h2o_e + M_q8_c => M_glcn_c + M_h_e + M_q8h2_c; 
  R_GLNS: M_atp_c + M_glu__L_c + M_nh4_c => M_adp_c + M_gln__L_c + M_h_c + M_pi_c; 
  R_GLUDy: M_glu__L_c + M_h2o_c + M_nadp_c -> M_akg_c + M_h_c + M_nadph_c + M_nh4_c; 
  R_GLUN: M_gln__L_c + M_h2o_c => M_glu__L_c + M_nh4_c; 
  R_GLUSy: M_akg_c + M_gln__L_c + M_h_c + M_nadph_c => 2 M_glu__L_c + M_nadp_c; 
  R_GND: M_6pgc_c + M_nadp_c => M_co2_c + M_nadph_c + M_ru5p__D_c;  
  R_GNK: M_atp_c + M_glcn_c => M_6pgc_c + M_adp_c + M_h_c; 
  R_ICDHyr: M_icit_c + M_nadp_c -> M_akg_c + M_co2_c + M_nadph_c; 
  R_KDPGALDOL: M_2ddg6p_c => M_g3p_c + M_pyr_c; 
  ...
  R_NADH16: 4 M_h_c + M_nadh_c + M_q8_c => 3 M_h_e + M_nad_c + M_q8h2_c; 
  R_PC: M_atp_c + M_hco3_c + M_pyr_c => M_adp_c + M_h_c + M_oaa_c + M_pi_c; 
  R_PDH: M_coa_c + M_nad_c + M_pyr_c -> M_accoa_c + M_co2_c + M_nadh_c; 
  R_PGI: M_g6p_c -> M_f6p_c; 
  R_PGLUCONDEHYDRAT: M_6pgc_c => M_2ddg6p_c + M_h2o_c; 
  R_PPC: M_hco3_c + M_pep_c => M_oaa_c + M_pi_c; 
  ...
  R_TKT1: M_g3p_c + M_s7p_c -> M_r5p_c + M_xu5p__D_c; 
  R_TKT2: M_e4p_c + M_xu5p__D_c -> M_f6p_c + M_g3p_c; 
  R_TPI: M_g3p_c -> M_dhap_c; 
  R_MALS: M_accoa_c + M_glx_c + M_h2o_c => M_coa_c + M_h_c + M_mal__L_c; 
  ...
  R_GLCabcpp_HEX1: 2 M_atp_c + M_glc__D_e + M_h2o_c => 2 M_adp_c + M_g6p_c + 2 M_h_c + M_pi_c; 
  # R_2DHGLCK: M_2dhglcn_c + M_atp_c + 2 M_h_c => M_6p2dhglcn_c + M_adp_c;  
  # R_PGLCNDH: M_6p2dhglcn_c + M_nadph_c -> M_6pgc_c + 2 M_h_c + M_nadp_c;  
  R_2DHGLCK_PGLCNDH: M_2dhglcn_c + M_atp_c + M_nadph_c => M_6pgc_c + M_nadp_c + M_adp_c; 
  # R_ICL: M_icit_c -> M_glx_c + M_succ_c;  
  # R_FRD7: M_fum_c + M_q8h2_c -> M_q8_c + M_succ_c;  
  R_ICL_FRD7: M_icit_c + M_q8_c -> M_glx_c + M_fum_c + M_q8h2_c; 
  # R_AKGDH: M_adp_c + M_akg_c + M_nad_c + M_pi_c => M_atp_c + M_co2_c + M_nadh_c + M_succ_c; 
  # R_FRD7: M_fum_c + M_q8h2_c -> M_q8_c + M_succ_c;  
  R_AKGDH_FRD7: M_q8_c + M_adp_c + M_akg_c + M_nad_c + M_pi_c => M_atp_c + M_co2_c + M_nadh_c + M_fum_c + M_q8h2_c; 
  # R_DDPA: M_e4p_c + M_h2o_c + M_pep_c -> M_2dda7p_c + M_pi_c; 
  # R_DHQS: M_2dda7p_c => M_3dhq_c + M_pi_c;  
  R_DDPA_DHQS: M_e4p_c + M_h2o_c + M_pep_c -> M_3dhq_c + 2 M_pi_c; 
  # R_DHSKDH: M_3dhsk_c => M_34dhbz_c + M_h2o_c;  
  # R_PCATDC: M_34dhbz_c + M_h_c -> M_catechol_c + M_co2_c; 
  R_DHSKDH_PCATDC: M_3dhsk_c + M_h_c => M_catechol_c + M_co2_c + M_h2o_c; 

  R_SHIK: M_3dhsk_c + M_nadph_c -> M_shik_c + M_nadp_c; 
  R_SHIK3P: M_shik_c + M_atp_c -> M_adp_c + M_shik3p_c; 
  R_5EPS3P: M_shik3p_c + M_pep_c -> M_5eps3p_c + M_pi_c; 
  R_CHOR: M_5eps3p_c -> M_chor_c + M_pi_c; 
  R_PAPA: M_chor_c + M_gln__L_c-> M_4a4dch_c + M_glu__L_c; 
  R_PAPB: M_4a4dch_c -> M_4a4dpr_c; 
  R_PAPC: M_4a4dpr_c + M_nad_c -> M_4aPPA_c + M_nadh_c + M_co2_c + M_h_c; 
  R_TYRB: M_4aPPA_c -> M_4aPhe_c; 
  R_PAL: M_4aPhe_c -> $M_4acinna_c; 
